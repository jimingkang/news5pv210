	...
	for (i = 0; i < 16; i++)
		for (j = 0; j < 2; j++)
		{
			...
			for (b = 7; b >=0; b--)
			{
				...
				{
					/* hide */
					lcd_put_pixel(x+j*8+7-b, y+i, 0); /* ºÚ */
				}
...
int main(int argc, char **argv)
{
	...
	/* ÒÔÉÏÊÇÓÃÀ´²âÊÔlcdµÄ²¿·Ö,²¢½«LCDµÄÏÔ´æÓ³ÉäÎªÁË(fbmem) */
/*---------------------------------------------------------------*/
	/* ½ÓÏÂÀ´ÊÇ²Ù×÷ÉãÏñÍ·,½«»ñµÃµÄÊý¾Ý·Åµ½fbmem,´Ó¶øÏÔÊ¾ */
	while(1)
	{
		printf("LCD is ok ?(y/n)\n");
	...
	/* A2 vidioc_querycap(²é¿´ÊÇ·ñÊÇÉãÏñÍ·Éè±¸) */
	/* A3 ÁÐ¾ÙÖ§³ÖÄÄÖÖ¸ñÊ½ */
	...
	/* A7 APPµ÷ÓÃ¸ÃioctlÈÃÇý¶¯³ÌÐò·ÖÅäÈô¸É¸ö»º´æ, APP½«´ÓÕâÐ©»º´æÖÐ¶Áµ½ÊÓÆµÊý¾Ý */

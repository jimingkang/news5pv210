...
static struct snd_soc_dai_ops wm8976_ops = {
...
{	
	...
	wm8976_write(codec, WM8976_JACK1, 0x040);    /* selected GPIO1 as jack detection input and Enable*/	
	//wm8976_write(codec, WM8976_JACK2, 0x021);    /* OUT2_EN_0 and OUT2_EN_1 */
	wm8976_write(codec, WM8976_JACK2, 0x0ff);
#endif
	...
	#if 0
	//ret = snd_soc_register_card(socdev->card);
...
static int wm8976_probe(struct platform_device *pdev)
{
	...
	{
		printk("wm8976_probe: i2c_master_send\n");

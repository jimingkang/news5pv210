...
void s3c_fimc0_cfg_gpio(struct platform_device *pdev)
{
	...
	for (i = 0; i < 5; i++) {
		...
		s3c_gpio_set_drvstrength(S5PV210_GPJ1(i), S3C_GPIO_DRVSTR_4X);
	}
#endif

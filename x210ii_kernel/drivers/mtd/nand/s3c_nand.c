...
struct mtd_partition s3c_partition_info[] = {
	{
		.name		= "uboot",				// 0x00000000-0x00080000
		.offset		= 0x00000000,
		.size		= (512*SZ_1K),
		.mask_flags	= MTD_CAP_NANDFLASH,
	},
	{
		.name		= "misc",			// 0x00080000-0x00100000
		.offset		= MTDPART_OFS_APPEND,
		.size		= (512*SZ_1K),
	},
	{
		.name		= "ramdisk",			// 0x00100000-0x00600000
		.offset		= MTDPART_OFS_APPEND,
		.size		= (5*SZ_1M),
	},
	{
		.name		= "kernel",				// 0x00600000-0x00b00000
		.offset		= MTDPART_OFS_APPEND,
		.size		= (5*SZ_1M),
	},
	{
		.name		= "system",				// 0x00b00000-0x03b00000
		.offset		= MTDPART_OFS_APPEND,	
		.size		= (80*SZ_1M),	
	},
	{

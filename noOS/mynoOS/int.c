...
void system_init_exception(void)
{
	...
	r_exception_data = (unsigned int)data_exception;
        ...
        //r_exception_reset = (unsigned int)reset;
	//r_exception_undef = (unsigned int)undefined_instruction;
	//r_exception_sotf_int = (unsigned int)software_interrupt;
	//r_exception_prefetch = (unsigned int)prefetch_abort;
	//r_exception_data = (unsigned int)data_abort;
